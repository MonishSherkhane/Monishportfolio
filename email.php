...
$subject = $_POST['Subject'];
    ...
    // $mailto = "monishsherkhane234@gmail.com"
    $mailto = "monishsherkhane07@gmail.com";
    // $mailto = "monishsherkhane07@gmail.com";
    ...
    $subject2 = "Confirmation: Your enquiry has been submitted successfully | RishiImpex Technology"; // For customer confirmation
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;min-width:100%;width:100%" width="100%">
              <tbody><tr>
                <td style="font-family:sans-serif;font-size:14px;vertical-align:top;text-align:center" valign="top" align="center">
                  <a href="#m_7874920153202582155_+style="><img src="https://portfolio.prudentmediagroup.com/websites/Atlantic/assets/images/atlantic-logo1.png" height="100" alt="RishiImpex Technology" style="border:none;max-width:100%" class="CToWUd" data-bit="iit"></a>
                </td>
              </tr>
            </tbody></table>
          </div>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;min-width:100%;width:100%" width="100%">
                    <tbody><tr>
                      <td style="font-family:sans-serif;font-size:14px;vertical-align:top" valign="top">
                        <p style="font-family:sans-serif;font-size:16px;font-weight:normal;margin:0;margin-bottom:6px">Hello <b><span class="il">RishiImpex Technology</span> Team</b>,</p>
